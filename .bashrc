...
export OSH='/home/a-victus/.oh-my-bash'
...
# Alias definitions.
# Aliases are in ~/dotfiles/.aliases, instead of adding them here directly.
...
__conda_setup="$('/home/a-victus/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/a-victus/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/a-victus/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/a-victus/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
